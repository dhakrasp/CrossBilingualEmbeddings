import os
import sys
os.system("python train_vec_model.py "+sys.argv[3]+" "+sys.argv[4])
os.system("~/Decoder/cdec/corpus/paste-files.pl "+sys.argv[1]+" "+sys.argv[2]+" > combine_"+sys.argv[3]+"_"+sys.argv[4])
temp="combine_"+sys.argv[3]+"_"+sys.argv[4]
